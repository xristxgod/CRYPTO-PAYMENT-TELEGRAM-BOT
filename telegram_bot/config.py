...
class Config(object):
    ...
    TRON_WITHDRAW_ADMIN_ADDRESS = environ.get('WITHDRAW_ADMIN_ADDRESS', '')
    TRON_WITHDRAW_ADMIN_PRIVATE_KEY = environ.get('WITHDRAW_ADMIN_PRIVATE_KEY', '')
    ...
    BSC_WITHDRAW_ADMIN_ADDRESS = environ.get('WITHDRAW_ADMIN_ADDRESS', '')
    BSC_WITHDRAW_ADMIN_PRIVATE_KEY = environ.get('WITHDRAW_ADMIN_PRIVATE_KEY', '')